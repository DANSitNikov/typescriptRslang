  ...
  return (
    <>
      ...
      <Button
        ...
        className={style.game_control_sound_btn}
      >
        <svg
...
ControlAnswerVolumeButton.propTypes = {
  soundStatus: PropTypes.bool.isRequired,
  setSoundStatus: PropTypes.func.isRequired,
};

export default ControlAnswerVolumeButton;
